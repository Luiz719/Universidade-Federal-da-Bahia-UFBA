...
function buildScene() {
   ...
   torusKnot.rotateY(-30*Math.PI/180);
   torusKnot.rotateZ(-20*Math.PI/180);
   torusKnot.rotateX(-30*Math.PI/180);
   scene.add( torusKnot );
   ...
   cilinder.rotateX(-40*Math.PI/180);
   scene.add( cilinder ); 
   ...
   plane.rotateY(-30*Math.PI/180);
   plane.rotateZ(-20*Math.PI/180);
   ...
   tetrahedron.rotateY(-30*Math.PI/180);
   tetrahedron.rotateZ(-10*Math.PI/180);
   tetrahedron.rotateX(-30*Math.PI/180);
   ...
   dodecahedron.rotateZ(-20*Math.PI/180);
   dodecahedron.rotateX(-30*Math.PI/180);
   scene.add( dodecahedron ); 
  
   var dodecahedronAxis = new THREE.AxesHelper( 0.3 );
   dodecahedron.add( dodecahedronAxis );  

   cube.userData.rotationAngle = new THREE.Vector3(0.02, 0, 0);
   sphere.userData.rotationAngle = new THREE.Vector3(0, 0.03, 0);
   ring.userData.rotationAngle = new THREE.Vector3(0, 0, 0.04);
   torusKnot.userData.rotationAngle = new THREE.Vector3(0, 0.02, 0);
   cilinder.userData.rotationAngle = new THREE.Vector3(0.03, 0, 0);
   icosahedron.userData.rotationAngle = new THREE.Vector3(0, 0, 0.02);
   plane.userData.rotationAngle = new THREE.Vector3(0.04, 0, 0);
   tetrahedron.userData.rotationAngle = new THREE.Vector3(0, 0.02, 0);
   dodecahedron.userData.rotationAngle = new THREE.Vector3(0, 0.03, 0);
};
    ...
    if (shouldRotate) {
        scene.traverse(function (object) {
            if (object instanceof THREE.Mesh) {
                object.rotateOnAxis(object.userData.rotationAngle.normalize(), 0.01); 
            }
        });
    }
