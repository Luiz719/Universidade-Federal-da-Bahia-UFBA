...
public class Mecha4 extends AdvancedRobot {
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
		...
		double [] prediction = targeting.predict(opp_lat_velocity, opp_velocity, e.getDistance(), bullet_power,
												forward_wall_distance, back_wall_distance, time_decelerated, time_changed_dir);
		double offset = prediction[0];
